...
class TestValidConditions(unittest.TestCase):
    ...
    def act_and_assert(self, conditions, test_list, clear=True):

        choice = Choice(self.choice_name, conditions, self.states)
    ...
    def test_cache_substitution(self):
        ...
        choice_1 = Choice(self.choice_name, conditions_1, self.states)
        ...
        choice_2 = Choice(self.choice_name, conditions_2, self.states)
    ...
    def test_simple_string_literals(self):
        ...
        self.act_and_assert(conditions, test_list)
